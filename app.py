...
# Streamlit app code
st.title("Aashvi Carbon Calculator App ⚠️")
...
if st.button("Calculate CO2 Emissions"):
    ...
    with col3:
        st.subheader("Aashvi Suggests that the Carbon Emissions by Category")
    ...
    with col4:
        st.subheader(" Aashvi Suggests that the Total Carbon Footprint")
